// SuperAdminDashboard.tsx - Complete with work timer, leave management, and payslips
...
const SuperAdminDashboard = () => {
  ...
  // Payslips data
  const payslips = [
    { month: 'May 2026', paidOn: '2026-05-31', gross: '₹2,85,000', net: '₹2,05,200' },
    { month: 'April 2026', paidOn: '2026-04-30', gross: '₹2,85,000', net: '₹2,05,200' },
    { month: 'March 2026', paidOn: '2026-03-31', gross: '₹2,85,000', net: '₹2,05,200' },
  ];
  ...
  useEffect(() => {
    const savedSessions = localStorage.getItem('superAdminWorkSessions');
    if (savedSessions) {
      try {
    ...
    const savedLeaves = localStorage.getItem('superAdminLeaveHistory');
    if (savedLeaves) {
      try {
  ...
  const leaveRequests: LeaveRequest[] = [
    { id: 'LR-3201', employee: 'Ishita Roy', type: 'Casual', period: '2026-06-12 - 2026-06-12', fromDate: '2026-06-12', toDate: '2026-06-12', duration: '1d', reason: 'Personal errand', status: 'Pending', submittedAt: '2026-06-10T10:00:00Z' },
    { id: 'LR-3202', employee: 'Karan Singh', type: 'Sick', period: '2026-06-04 - 2026-06-05', fromDate: '2026-06-04', toDate: '2026-06-05', duration: '2d', reason: 'Flu recovery', status: 'Pending', submittedAt: '2026-06-03T08:30:00Z' },
    { id: 'LR-3203', employee: 'Meera Joshi', type: 'Earned', period: '2026-06-22 - 2026-06-26', fromDate: '2026-06-22', toDate: '2026-06-26', duration: '5d', reason: 'Family vacation', status: 'Pending', submittedAt: '2026-06-18T14:00:00Z' },
    { id: 'LR-3204', employee: 'Sneha Pillai', type: 'Comp-Off', period: '2026-06-09 - 2026-06-09', fromDate: '2026-06-09', toDate: '2026-06-09', duration: '1d', reason: 'Weekend release support', status: 'Approved', submittedAt: '2026-06-05T09:00:00Z' },
    { id: 'LR-3205', employee: 'Ananya Iyer', type: 'Maternity', period: '2026-07-01 - 2026-12-31', fromDate: '2026-07-01', toDate: '2026-12-31', duration: '184d', reason: 'Statutory maternity leave', status: 'Approved', submittedAt: '2026-06-01T11:00:00Z' }
  ];
  ...
  const handleStopWork = async () => {
    ...
    try {
      ...
      localStorage.setItem('superAdminWorkSessions', JSON.stringify(updatedSessions));
  ...
  const handleSubmitLeave = () => {
    ...
    const newLeave: LeaveRequest = {
      id: `LR-${String(leaveHistory.length + leaveRequests.length + 1).padStart(4, '0')}`,
    ...
    localStorage.setItem('superAdminLeaveHistory', JSON.stringify(updatedLeaves));
  ...
  const generatePayslipData = (employeeName?: string): PayslipData => {
    ...
    return {
      employeeId: 'SE-001',
      name: employeeName || 'Aarav Mehta',
      designation: 'Super Admin',
      email: 'aarav@servease.com',
      payPeriod: 'May 2026',
  ...
  // Render Overview Tab (with Timer)
    ...
    <div className="space-y-4 sm:space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        ...
        <div className={`${tc.bgCard} p-4 sm:p-6 rounded-2xl ${tc.border} ${tc.shadow} hover:scale-[1.02] transition-transform duration-300`}>
          ...
          <p className="text-xl sm:text-2xl font-bold text-emerald-400">₹6,15,600</p>
